    ...
    <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-5 mb-3">
      ...
      <div className="relative mb-4">
        ...
        <input
          ...
          placeholder="40000"
          className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-xl text-[16px] font-medium focus:outline-none focus:ring-2 focus:ring-[#FF4D00] focus:border-transparent"
          autoFocus
        />
      </div>
